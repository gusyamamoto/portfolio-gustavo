		...
		?><div class="paragraph-wrapper">
			...
			<div class="about-para-third">
				...
				<div class="lang-icons">
					<?php
					echo get_svg_icon('html');
					echo get_svg_icon('css');
					echo get_svg_icon('sass');
					echo get_svg_icon('js');
					echo get_svg_icon('react');
					echo get_svg_icon('php');
					echo get_svg_icon('wordpress');
					echo get_svg_icon('woocommerce');
					echo get_svg_icon('shopify');
					echo get_svg_icon('git');
					echo get_svg_icon('github');
					echo get_svg_icon('figma');
					?>
